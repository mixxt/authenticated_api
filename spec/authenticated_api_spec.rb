...
describe "AuthenticatedApi" do
  ...
  describe "generating secret keys" do
    ...
    it "should generate secret keys that are 89 characters" do
      AuthenticatedApi.generate_secret_key.size.should be(89)
    end
  
    it "should generate keys that have a Hamming Distance of at least 65" do
      key1 = AuthenticatedApi.generate_secret_key
      key2 = AuthenticatedApi.generate_secret_key
  ...
  describe "signing requests" do
    ...
    def hmac(secret_key, request)
      canonical_string = AuthenticatedApi::Headers.new(request).canonical_string
    ...
    before(:all) do
      @access_id = "1044"
      @secret_key = AuthenticatedApi.generate_secret_key
    end
    ...
    describe "with Net::HTTP" do
      ...
      before(:each) do
        ...
        @signed_request = AuthenticatedApi.sign!(@request, @access_id, @secret_key)
      end
      
      it "should return a Net::HTTP object after signing it" do
        AuthenticatedApi.sign!(@request, @access_id, @secret_key).class.to_s.should match("Net::HTTP")
      end
      ...
      it "should authenticate a valid request" do
        AuthenticatedApi.authentic?(@signed_request, @secret_key).should be_true
      end
      
      it "should NOT authenticate a non-valid request" do
        AuthenticatedApi.authentic?(@signed_request, @secret_key+'j').should be_false
      end
      
      it "should retrieve the access_id" do
        AuthenticatedApi.access_id(@signed_request).should == "1044"
      end
    ...
    describe "with RestClient" do
      ...
      it "should return a RestClient object after signing it" do
        AuthenticatedApi.sign!(@request, @access_id, @secret_key).class.to_s.should match("RestClient")
      end
    ...
    describe "with Curb" do
      ...
      it "should return a Curl::Easy object after signing it" do
        AuthenticatedApi.sign!(@request, @access_id, @secret_key).class.to_s.should match("Curl::Easy")
      end
